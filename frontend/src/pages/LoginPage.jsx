...
const LoginPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-pink-500'>Create your account</h2>
			</motion.div>
				...
				<div className='bg-black py-8 px-4 shadow sm:rounded-lg sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-6'>
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 
						...
						<button
							...
							rounded-md shadow-sm text-sm font-medium text-white bg-pink-500
